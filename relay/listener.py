...
from pytgcalls.types import AudioQuality, RecordStream
...
class VC1Listener:
    ...
    async def start(self, chat_id):
        """Join VC1 and begin recording audio stream."""
        ...
        try:
            ...
            logger.info(f"Listener joined group: {self.chat_id}")
        ...
        # Hook PyTgCalls deep update logger
